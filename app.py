...
# 歷史數據與圖表運算：快取 1 小時，避免圖表每 2 秒重畫導致閃爍
...
if st.sidebar.button("🔄 刷新全部圖表", type="primary"):
    st.cache_data.clear()
    st.rerun()
...
# --- 9. 技術圖表 (因為有 @st.cache_data，不會每 2 秒重畫) ---
st.divider()
